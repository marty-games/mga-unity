function createUnityInstance(t, r, d) {
    ...
    o.isConnected = new Promise(function(t, r) {
      try {
        ...
        e.onupgradeneeded = function(e) {
          var t;
          (e = (e = e).target.result).objectStoreNames.contains(h.name) || e.createObjectStore(h.name), e.objectStoreNames.contains(l.name) || (t = e.createObjectStore(l.name, {
            keyPath: "url"
  ...
  return c.SystemInfo = function() {
    ...
    for (var d = [
      ...
      h = ((h = document.createElement("canvas")) && (l = (f = h.getContext("webgl2")) ? 2 : 0, f || (f = h && h.getContext("webgl")) && (l = 1), f && (n = f.getExtension("WEBGL_debug_renderer_info") && f.getParameter(37446) || f.getParameter(7937))), "undefined" != typeof SharedArrayBuffer),
      ...
      function o() {
        return void 0 === e ? a.arrayBuffer().then(function(e) {
          ...
          if (e.done) {
            ...
            for (var t = new Uint8Array(h), r = (t.set(l, 0), f), n = 0; n < c.length; ++n) t.set(c[n], r), r += c[n].length;
            return t
          }
          return h + e.value.length <= l.length ? (l.set(e.value, h), f = h + e.value.length) : c.push(e.value), h += e.value.length, s({
            type: "progress",
            response: a,
            total: Math.max(u, h),
            loaded: h,
    ...
    name: "WebAssembly",
    version: 1
  }, f = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, S.UnityCacheDatabase = u, S.RequestStore = l, S.WebAssemblyStore = h, p = null, S.getInstance = function() {
    return p = p || new S
